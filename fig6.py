...
matplotlib.pyplot.plot(city, population1, 'gs', color='blue')
matplotlib.pyplot.plot(city, population2, 'gX', linestyle='dotted', color='blue')
matplotlib.pyplot.plot(city, population3, 'b^-.', color='blue')
matplotlib.pyplot.plot(city, population4, 'm*-', color="black")
'''
